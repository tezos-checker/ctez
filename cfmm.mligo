...
// #define TOKEN_IS_FA2 (* comment to make the token FA1.2 instead *)
// #define HAS_BAKER (* uncomment to add a baker *)
...
(* TODO : for the tez/ctez contract specifically: consider adding an entrypoint to chain it with a ctez/token contract *)
